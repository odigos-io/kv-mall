...
build-push-images-prod: generate-webapp
	...
	docker buildx build -t keyval/kv-mall-coupon:v0.3 $(PROJECT_DIR)coupon -f $(PROJECT_DIR)coupon/Dockerfile --platform linux/amd64,linux/arm64 --push
	...
	docker buildx build -t keyval/kv-mall-analytics:v0.3 $(PROJECT_DIR)analytics -f $(PROJECT_DIR)analytics/Dockerfile --platform linux/amd64,linux/arm64 --push
